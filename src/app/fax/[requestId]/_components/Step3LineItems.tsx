    ...
    return (
      <li
        className={cn(
          ...
          item.isLowConfidence ? 'bg-yellow-50 border-l-4 border-yellow-500 border-r border-y border-r-slate-200 border-y-slate-200' : 'border-slate-200',
        )}
      >
        <div className="flex items-center justify-between">
